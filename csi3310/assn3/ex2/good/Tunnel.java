  ...
  public static void main(String[] args)
   {
    ...
    TrafficQueue northQueue = new TrafficQueue(NORTH) ;
    TrafficQueue southQueue = new TrafficQueue(SOUTH) ;
    Controller monitor = new Controller(northQueue, southQueue) ;

    // create the Cars
    Car[] auto = new Car[TOTAL_CARS] ;
    for (int i=0; i < NORTH_CARS ; i++)
       auto[i] = new Car(monitor, northQueue, i) ;
    for (int i=0; i < SOUTH_CARS ; i++)
       auto[i+NORTH_CARS] = new Car(monitor, southQueue, i) ;
