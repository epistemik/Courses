...
.data
	...
	first_prec  db  "The 1st string alphabetically precedes the 2nd.",0Ah,0Ah,0h
	second_prec  db "The 2nd string alphabetically precedes the 1st.",0Ah,0Ah,0h
	identical  db  "The two strings are identical.",0Ah,0Ah,0h
	prec  db  0h
...
main:
	...
	prep2:
		...
		sub ebp,2 			; adjust ebp to point to char one of 1st string
		sub esi,2 			; adjust esi to point to char one of 2nd string
