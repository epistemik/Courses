...
.data
	...
	greet_msg  db  "Enter a boolean number as a string of at most 128 chars:",10,0
	error_msg  db  "Wrong input, now exiting...",10,0
	disp_msg   db  "This number in hexadecimal is:",10,0
...
Display:
		...
		putstr disp_msg
		and ebx,3           ; want to check bits 0 & 1 of the counter
		mov ecx,ebx         ; set the loop count to the number of extra digits
		jecxz Disp_loop     ; skip if zero, ie. input digits were a multiple of 4
